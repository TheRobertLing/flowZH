...
<template>
  <div v-if="isLoading" class="bg-base-200 min-h-screen flex justify-center items-center">
    <LoadingBarComponent />
  </div>
  <div class="bg-base-200 min-h-screen flex flex-col justify-center items-center" v-else>
    <PTCounterComponent />
    {{ data }}
